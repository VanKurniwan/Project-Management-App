    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="/" class="flex items-center">
                <img src="{{ URL('storage/img/logo-medium-blue.svg') }}" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                <span class="self-center text-base lg:text-lg font-semibold whitespace-nowrap dark:text-white">
                    Project Management
                </span>
            </a>
            <div class="flex items-center lg:order-2">
                ...
                {{-- Tombol SETTINGS --}}
                <a href="#"
                    class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-2 lg:px-3 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    <li>
                        <x-navlink href="/" :active="request()->is('/')">Projects Overview</x-navlink>
                    </li>
                    <li>
                        <x-navlink href="/all" :active="request()->is('all')">All Projects</x-navlink>
                    </li>
                    <li>
                </ul>
            </div>
